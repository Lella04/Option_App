...
struct Option: Codable {
    ...
    var imagename: String
        var squareColorString: String
        func getSquareColor() -> Color {
            if let color = Color(hex: squareColorString) {
                return color
            } else {
                return Color.black
            }
...
extension Color {
    init?(hex: String) {
        ...
        guard Scanner(string: formatted).scanHexInt64(&rgb) else {
            return nil
        }
...
extension Option {
    ...
    static let options: [Option] = [
        .init(id: 1, title: "General", isAddSection: false, values: generalValues, imagename: "gear", squareColorString: "98989D"),
        .init(id: 2, title: "Accessibility", isAddSection: false, values: accessibilityValues, imagename: "accessibility", squareColorString: "0B84FF"),
        .init(id: 3, title: "Privacy", isAddSection: false, values: privacyValues, imagename: "hand.raised.fill", squareColorString: "0B84FF"),
        .init(id: 4, title: "Password & Accounts", isAddSection: true, values: passwordAndAccountsValues, imagename: "key.fill", squareColorString: "98989D"),
        .init(id: 5, title: "Maps", isAddSection: false, values: mapsValues, imagename: "map.fill", squareColorString: "0B84FF"),
        .init(id: 6, title: "Safari", isAddSection: false, values: safariValues, imagename: "cloud.fill", squareColorString: "0B84FF"),
        .init(id: 7, title: "News", isAddSection: false, values: newsValues, imagename: "cloud.fill", squareColorString: "0B84FF"),
        .init(id: 8, title: "Developer", isAddSection: true, values: developerValues, imagename: "hammer.fill", squareColorString: "98989D")
    ]
}
